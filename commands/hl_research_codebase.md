...
5. **Gather metadata for the research document:**
   - Run the `~/.agents/scripts/spec_metadata.sh` script to generate all relevant metadata
   - Filename: `docs/plans/YYYY-MM-description/research.md`
     ...
     - Examples:
       - With ticket: `2025-01-ENG-1478-parent-child-tracking/research.md`
       - Without ticket: `2025-01-authentication-flow/research.md`

   If user has already created the folder structure, use that directly.

   Otherwise, generate 3 variants of the description for user selection and obtain user confirmation on the final name.
   This name will be used as a git branch name as well.
...
6. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     **Repository**: [Repository name]
     ...
     - `docs/path-to/something.md` - Historical decision about X
     - `docs/path-to/notes.md` - Past exploration of Y
